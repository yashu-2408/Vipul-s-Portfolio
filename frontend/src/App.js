            ...
            <div className="education-timeline">
              <div className="education-item">
                ...
                <div className="education-content">
                  ...
                  <p className="text-blue-400 mb-2">B.E. in Computer Science</p>
                  <p className="text-gray-400">CGPA: 7.76</p>
                </div>
              </div>
              <div className="education-item">
                <div className="education-date">2020 - 2021</div>
                <div className="education-content">
                  <h3 className="text-2xl font-bold text-white mb-2">Sri Chaitanya Techno School</h3>
                  <p className="text-blue-400 mb-2">Higher Secondary, Vishakhapatnam</p>
                  <p className="text-gray-400">96.7%</p>
                </div>
              </div>
              <div className="education-item">
                <div className="education-date">2018 - 2019</div>
                <div className="education-content">
                  <h3 className="text-2xl font-bold text-white mb-2">S.D.S.V.M, Samastipur</h3>
                  <p className="text-blue-400 mb-2">Senior Secondary</p>
